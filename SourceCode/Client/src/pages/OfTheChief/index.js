                        ...
                        {allUser && allUser.map(user => (
                            <tr key={user.id}>
                                ...
                                <td className={style.btnAction}>
                                    <Button  className={style.btnAuth} variant="contained" onClick={() => handleOpen('auth', user.id, user.roleId)} sx={{ fontSize: '12px' }} >
                                        Phân Quyền
                                    </Button>
                                    <Button  className={style.btnShift} variant="contained" onClick={() => handleOpen('shifts', user.id, user.roleId)} sx={{ fontSize: '12px' }} >
                                        Chia Ca
                                    </Button>
                                </td>
                            </tr>
